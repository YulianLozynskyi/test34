...
@InputType()
class SickLeaveCreateNestedManyWithoutEmployeesInput {
...
export { SickLeaveCreateNestedManyWithoutEmployeesInput as SickLeaveCreateNestedManyWithoutEmployeesInput };
